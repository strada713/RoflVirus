...
## ⚡ Features
* Funny terminal pop-ups and custom interactions.
* Lightweight C++ code running natively on Linux/Arch.
* Great way to learn how desktop environments handle unexpected events.

## 🛠️ How to Compile (Arch Linux)
```bash
g++ watcher.cpp -o roflvirus
./roflvirus
```
